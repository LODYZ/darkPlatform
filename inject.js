...
/**
 * Inject del css interno di dark platform
 * Usato per lo stile di   gae sync 
 */	
fetch(chrome.runtime.getURL("./assets/css/dark-platform.css")).then(function(response) {
	var style = document.createElement("style");
	style.id = "darkPlatform";
